...
class playerCreation {
	...
	////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by Salami, v1.063, #Qyhici)
////////////////////////////////////////////////////////
	...
	{
		idc = 1600;
		action = "[1000, 1100] call sal_fnc_specialUp; playSound 'pipboyClick';"
	...
	{
		idc = 1601;
		action = "[1000, 1100] call sal_fnc_specialDown; playSound 'pipboyClick';"
	...
	{
		idc = 1602;
		action = "[1001, 1101] call sal_fnc_specialUp; playSound 'pipboyClick';"
	...
	{
		idc = 1603;
		action = "[1001, 1101] call sal_fnc_specialDown; playSound 'pipboyClick';"
		x = 0.28125 * safezoneW + safezoneX;
	...
	{
		idc = 1604;
		action = "[1002, 1102] call sal_fnc_specialUp; playSound 'pipboyClick';"
	...
	{
		idc = 1605;
		action = "[1002, 1102] call sal_fnc_specialDown; playSound 'pipboyClick';"
		x = 0.28073 * safezoneW + safezoneX;
	...
	{
		idc = 1606;
		action = "[1003, 1103] call sal_fnc_specialUp; playSound 'pipboyClick';"
		x = 0.28125 * safezoneW + safezoneX;
	...
	{
		idc = 1607;
		action = "[1003, 1103] call sal_fnc_specialDown; playSound 'pipboyClick';"
		x = 0.28125 * safezoneW + safezoneX;
	...
	{
		idc = 1608;
		action = "[1004, 1104] call sal_fnc_specialUp; playSound 'pipboyClick';"
		x = 0.280729 * safezoneW + safezoneX;
	...
	{
		idc = 1609;
		action = "[1004, 1104] call sal_fnc_specialDown; playSound 'pipboyClick';"
		x = 0.280729 * safezoneW + safezoneX;
	...
	{
		idc = 1610;
		action = "[1005, 1105] call sal_fnc_specialUp; playSound 'pipboyClick';"
	...
	{
		idc = 1611;
		action = "[1005, 1105] call sal_fnc_specialDown; playSound 'pipboyClick';"
		x = 0.280729 * safezoneW + safezoneX;
	...
	{
		idc = 1612;
		action = "[1006, 1106] call sal_fnc_specialUp; playSound 'pipboyClick';"
		x = 0.280729 * safezoneW + safezoneX;
	...
	{
		idc = 1613;
		action = "[1006, 1106] call sal_fnc_specialDown; playSound 'pipboyClick';"
